...
**Today's Progress**: Audit Fixes, and finally fixed the S3 Image stuff!

**Topics**: S3 Policies/Integration, Audit Fixing

**Thoughts**: I finally got around to setting up the S3 bucket properly, along with writing some README's and fixing auditing issues!

**Links**: Check out the fixed images at [https://now-thats-delicious-leeandher.herokuapp.com](https://now-thats-delicious-leeandher.herokuapp.com)!

**Goals for Tomorrow**: Record the Demo gifs, and some Unity Stuff!

---

### Day 061: November 30, 2018

**Today's Progress**: [Space Shooter Tutorial][utc] in Unity

**Topics**: Set up the player, and bolt assets

**Thoughts**: Slow day, but I think I need one of those every once in a while.

**Links**: [Unity Tutorial Repo][utr]

**Goals for Tomorrow**: Get back on that twitter CLI thing!
